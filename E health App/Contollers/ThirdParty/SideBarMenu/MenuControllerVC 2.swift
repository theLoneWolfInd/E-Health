    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any]  {
            ...
            if (person["role"] as! String) == "Hospital" {
                ...
                if arrHospitalTitle[indexPath.row] == "Home" {
                ...
                } else if arrHospitalTitle[indexPath.row] == "Search Appointments" {
                    ...
                    let sw = storyboard.instantiateViewController(withIdentifier: "sw") as! SWRevealViewController
                    self.view.window?.rootViewController = sw
                    let destinationController = self.storyboard?.instantiateViewController(withIdentifier: "DPSearchReportId")
                    let navigationController = UINavigationController(rootViewController: destinationController!)
                    sw.setFront(navigationController, animated: true)
                ...
                else if arrDoctorTitle[indexPath.row] == "Search Appointments" {
                ...
                else if arrDoctorTitle[indexPath.row] == "Signout" {
                ...
                if arrSupplierTitle[indexPath.row] == "Home" {
                ...
                } else if arrSupplierTitle[indexPath.row] == "Search Orders"  {
                    ...
                    let sw = storyboard.instantiateViewController(withIdentifier: "sw") as! SWRevealViewController
                    self.view.window?.rootViewController = sw
                    let destinationController = self.storyboard?.instantiateViewController(withIdentifier: "ReceivedOrdersId")
                    let navigationController = UINavigationController(rootViewController: destinationController!)
                    sw.setFront(navigationController, animated: true)
                ...
                }  else if arrLabTitle[indexPath.row] == "Search Tests" {
                ...
                if arrPharmacyTitle[indexPath.row] == "Help" {
                    ...
                    let sw = storyboard.instantiateViewController(withIdentifier: "sw") as! SWRevealViewController
                    self.view.window?.rootViewController = sw
                    let destinationController = self.storyboard?.instantiateViewController(withIdentifier: "PatientRecordsId")
                    let navigationController = UINavigationController(rootViewController: destinationController!)
                    sw.setFront(navigationController, animated: true)
                     
                } else if arrPharmacyTitle[indexPath.row] == "Search Prescriptions" {
