...
struct list_of_all_medicines_via_doctor: Encodable {
    let action: String
...
struct panic_reply_hospital_accept: Encodable {
    let action: String
    let userId: String
...
struct active_pharmacy_list: Encodable {
    let action: String
    let userId: String
    let timespan: String
    let start_date: String
...
struct status_change_request_test_from_lab: Encodable {
    let action: String
    let userId: String
    let hospitalId: String
    let testId: String
...
/*
 [action] => orderhistory
     ...
     [keyword] =>
 */
struct filter_order_history: Encodable {
    let action: String
    let userId: String
    let start_date: String
    let end_date: String
...
/*
 [action] => deletemedicine
    ...
    [medicine_id] => 141053
 */
struct delete_medine_wb: Encodable {
    let action: String
    let diseaseId: String
...
/*
 [action] => userlist
     ...
     [keyword] =>
 */
struct search_patient_records: Encodable {
    let action: String
    let role: String
    let addedBy: String
    let start_date: String
...
struct request_medical_history_permission: Encodable {
    let action: String
    let userId: String
    let login_id: String
    let hospitalId: String
...
struct pharmacy_prescription_permission_to_patient: Encodable {
    let action: String
    let userId: String
    let hospitalId: String
    let prescriptionId: String
...
struct lab_test_list_permission_check: Encodable {
    let action: String
    let userId: String
    let doctorId: String
    let appointmentId: String
...
struct lab_test_request: Encodable {
    let action: String
    let userId: String
    let hospitalId: String
    let testId: String
