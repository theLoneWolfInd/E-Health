//
//  HospitalNewLabeRegistrationTableCell.swift
//  E health App
//
...
class HospitalNewLabeRegistrationTableCell: UITableViewCell {

    @IBOutlet weak var txtName:UITextField! {
        didSet {
            
            Utils.txtUitextField(textField: txtName, placeholderName: "Lab Name", setLeftPadding: 20)
