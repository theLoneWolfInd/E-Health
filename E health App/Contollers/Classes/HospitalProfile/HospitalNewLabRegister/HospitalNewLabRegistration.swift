//
//  HospitalNewLabRegistration.swift
//  E health App
//
...
class HospitalNewLabRegistration: UIViewController , CLLocationManagerDelegate, UINavigationControllerDelegate , UIImagePickerControllerDelegate {
...
extension HospitalNewLabRegistration:UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:HospitalNewLabeRegistrationTableCell = tablView.dequeueReusableCell(withIdentifier: "hospitalNewLabeRegistrationTableCell")as! HospitalNewLabeRegistrationTableCell
