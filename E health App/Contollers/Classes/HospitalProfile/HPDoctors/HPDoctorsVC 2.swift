...
class HPDoctorsVC: UIViewController {
    ...
    var str_my_value:Int!
    var str_from_filter:String!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        } else if self.strMyProfileIs == "search_records_pharmacy" {
    ...
    @objc func calculate_dates() {
        ...
        self.search_patient_Records_wb(str_role: "Patient")
    ...
    @objc func search_patient_Records_wb(str_role:String) {
        self.arrListOfAllDoctors.removeAllObjects()
        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            let params = search_patient_records(action: "userlist",
                                                role: String(str_role),
                                                addedBy: String(myString),
                                                start_date: String(self.str_start_Date_is),
                                                end_date: String(self.str_end_Date_is),
                                                paid: String(self.str_paid_patient),
                                                keyword: "")
    ...
    @objc func deleteDoctorFromListClickMethod(_ sender:UIButton) {
        ...
        if strMyProfileIs == "FromHospitalProfileToDoctors" {
            ...
            let alert = UIAlertController(title: String("Delete Patient"), message: "Are you sure you want to delete \n\n Patient :  '\(item!["fullName"] as! String)'", preferredStyle: .alert)
