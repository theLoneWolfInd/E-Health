//
//  DLDashbaordTableViewCell.swift
//  E health App
//
...
class DLDashbaordTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var btnAllPatient:UIButton!{
        didSet{
            ...
            btnAllPatient.setTitle("All Patients", for: .normal)
        }
    }
    @IBOutlet weak var btnRqstSupplier:UIButton!{
        didSet {
            ...
            btnRqstSupplier.setTitle("Request Supplier", for: .normal)
        }
    }
