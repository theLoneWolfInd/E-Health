...
class orderHistoryVC: UIViewController,UITableViewDelegate, UITableViewDataSource,UISearchBarDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if self.str_from_filter == "yes" {
            
            
            
            if self.str_search_report_data == "custom_search" {
                
                self.search_order_filter_wb()
    ...
    @objc func search_order_filter_wb() {
        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            let params =  filter_order_history(action: "orderhistory",
