...
class AddMoreMedicines: UIViewController , UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    var str_check_medicines:String!
    
    var edit_medicine:String!
    var get_medicine_Details:NSDictionary!
    
    var getProfileInfo:String!
    var getDictOfThatMedicine:NSDictionary!
    
    var str_sm_id:String!
    ...
    override func viewDidLoad() {
        ...
        if self.getProfileInfo == "edit_medicine" {
            ...
            // print(self.get_medicine_Details as Any)
            ...
            let x : Int = (self.getDictOfThatMedicine["diseaseId"] as! Int)
            let myString = String(x)
            
            let x2 : Int = (self.getDictOfThatMedicine["sm_id"] as! Int)
            let myString2 = String(x2)
            
            self.getDieseaaseId = String(myString)
            self.str_sm_id = String(myString2)
            
            
            /*
            // for name
            let indexPath1 = IndexPath.init(row: 1, section: 0)
            let cell1 = self.tbleView.cellForRow(at: indexPath1) as! AddMoreMedicinesTableCell
            
            cell1.lblCell2MedicineName.text = (self.get_medicine_Details["name"] as! String)*/
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        /*if let myString = defaults.string(forKey: "key_search_name") {
        ...
        if let myString = defaults.string(forKey: "key_medicine_id") {
            ...
            // self.getProfileInfo = "edit_medicine_2"
            ...
            if self.getProfileInfo == "edit_medicine" {
                ...
                let x : Int = (self.getDictOfThatMedicine["medicineId"] as! Int)
                let myString = String(x)
                
                self.strSaveMedicineId = String(myString)
    ...
    @objc func validationBeforeAddMedicine() {
        ...
        if self.getProfileInfo == "edit_medicine" {
            ...
            if self.imageStr1 == "1" {
                ...
                self.editMedicineWithImageWB(imageData: imgData1 as NSData)
             ...
             if self.imageStr1 == "1" {
                 ...
                 self.addMedicineWithImageWB(imageData: imgData1 as NSData)
    ...
    @objc func editMedicineWithImage() {
        ...
        do {
            ...
            self.editMedicineWithImageWB(imageData: imageData as NSData)
        } catch {
    ...
    @objc func editMedicineWithImageWB(imageData:NSData) {
        ...
        if let person = UserDefaults.standard.value(forKey: "keyLoginFullData") as? [String:Any] {
            ...
            parameterDict.setValue(String(self.str_sm_id), forKey: "sm_id")
            ...
            parameterDict.setValue(String(self.strSaveMedicineId), forKey: "medicineId")
            ...
            AF.upload(multipartFormData: { multiPart in
                ...
                multiPart.append(imageData as Data, withName: "image", fileName: "editedMedicineName.png", mimeType: "image/png")
            }, with: urlRequest)
...
extension AddMoreMedicines : UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            } else if self.getProfileInfo == "edit_medicine_2" {
                
                //cell.lblCell2MedicineName.text = self.strSaveMedicineName
                // cell.lblCell2MedicineName.text = self.strSaveMedicineImage
