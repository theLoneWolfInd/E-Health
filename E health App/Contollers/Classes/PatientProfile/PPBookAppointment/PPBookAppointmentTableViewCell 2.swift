//
//  PPBookAppointmentTableViewCell.swift
//  E health App
//
...
class PPBookAppointmentTableViewCell: UITableViewCell {
   ...
   @IBOutlet weak var viewProfileBG:UIView!{
    ...
    @IBOutlet weak var lblHospitalAbout:UILabel!
