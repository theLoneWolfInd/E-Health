...
extension OrderItems: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if item!["price"] is String {
            ...
            cell.lblQuantity.text = "Quantity : "+myString2+"|| Price : "+(item!["price"] as! String)
            ...
            cell.lblQuantity.text = "Quantity : "+myString2+"|| Price : "+myString
            
        } else {
            
            let temp:NSNumber = item!["price"] as! NSNumber
            let tempString = temp.stringValue
            cell.lblQuantity.text = "Quantity : "+myString2+"|| Price : "+tempString
        }
